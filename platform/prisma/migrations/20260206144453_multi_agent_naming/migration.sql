...
INSERT INTO "new_BotConfig" ("apiBase", "apiKey", "browserEnabled", "createdAt", "discordEnabled", "discordToken", "feishuAppId", "feishuAppSecret", "feishuEnabled", "gatewayHost", "gatewayPort", "githubToken", "id", "lastRun", "maxToolIterations", "model", "provider", "restrictToWorkspace", "shellEnabled", "status", "telegramEnabled", "telegramToken", "updatedAt", "userId", "webSearchApiKey", "whatsappEnabled") SELECT "apiBase", "apiKey", "browserEnabled", "createdAt", "discordEnabled", "discordToken", "feishuAppId", "feishuAppSecret", "feishuEnabled", "gatewayHost", "gatewayPort", "githubToken", "id", "lastRun", "maxToolIterations", "model", "provider", "restrictToWorkspace", "shellEnabled", "status", "telegramEnabled", "telegramToken", "updatedAt", "userId", "webSearchApiKey", "whatsappEnabled" FROM "BotConfig";
